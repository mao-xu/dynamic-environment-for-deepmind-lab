...
srcs = ["python/nav_a3c/train_a3c.py"],

main = "python/nav_a3c/train_a3c.py",
...
srcs = ["python/nav_a3c/test_a3c.py"],

main = "python/nav_a3c/test_a3c.py",
...
py_binary(
    ...
    srcs = ["python/GA3C-DeepNavigation/GA3C.py"],
    data = [":deepmind_lab.so"],
    main = "python/GA3C-DeepNavigation/GA3C.py",
)



py_binary(
    name = "GA3C-DeepNavigation_attention_train",
    srcs = ["python/GA3C-DeepNavigation/GA3C.py"],
    data = [":deepmind_lab.so"],
    main = "python/GA3C-DeepNavigation/GA3C.py",
)
